      ...
      <div className='flex flex-col gap-1 w-[calc(100%-66px)] ml-4'>
        ...
        <div className='flex justify-between text-white text-base'>
          ...
          <div className="flex  items-center justify-center group">
            <span className=" hover:bg-[#a309241a] group-hover:text-[#f54866] w-10 h-10 flex items-center justify-center rounded-full" onClick={likeToTweet}>
              <i className="fa-regular fa-heart" ></i>
            </span>
            <span className='text-gray-400 text-xs group-hover:text-[#f54866]'>{likes}</span>
          </div>
