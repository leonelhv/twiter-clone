...
export default function Tweet ({ tweet }: Props) {
    ...
    return (
        <Link to={goToTweet()} className='flex w-full border-t-[.3px] p-4 border-gray-200/20 cursor-pointer'>
            ...
            <div className='flex flex-col gap-1 w-[calc(100%-66px)] ml-4'>
                ...
                <span className='text-white block break-words'>{tweet.content}</span>
